        ...
        <div className='w-11/12 grid md:grid-cols-2 justify-between px-40 pt-20'>
          <div className='py-40'>
            ...
            <p>Access premium AI tools, design assets, templates, and productivity<br/>
               ...
               <div className='mt-5'>
                <button class="btn btn-primary rounded-4xl bg-linear-to-r from-blue-600 to-purple-600 mr-5">Explore Products</button>
                <button class="btn btn-neutral btn-outline rounded-4xl text-blue-600 border-blue-600"><img src={play}></img> Watch Demo</button>
               </div>
            </div>  
