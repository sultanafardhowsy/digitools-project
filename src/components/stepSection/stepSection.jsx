        ...
        <div className='my-20'>
            ...
            <h4 className='text-center mt-4 mb-10'>Start using premium digital tools in minutes, not hours.</h4>
                ...
                <div className='grid md:grid-cols-3 w-11/12 mx-auto'>
                    <div className='mb-5  border border-amber-100 rounded-2xl w-90 h-90 relative'>
                        <span className='bg-blue-600 rounded-full px-4 py-2 absolute top-4 right-4 text-white'>01</span>
                ...
                <div className='mb-5  border border-amber-100 rounded-2xl w-90 h-90 relative'>
                    <span className='bg-blue-600 rounded-full px-4 py-2 absolute top-4 right-4 text-white'>02</span>
                ...
                <div className='mb-5  border border-amber-100 rounded-2xl w-90 h-90 relative'>
                    <span className='bg-blue-600 rounded-full px-4 py-2 absolute top-4 right-4 text-white'>03</span>
